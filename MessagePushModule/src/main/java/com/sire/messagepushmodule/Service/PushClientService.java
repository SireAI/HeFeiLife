 ...
 * android:process=":pushservice",PushManager.getInstance().initialize(this.getApplicationContext(), userPushService), 其中
...
public class PushClientService extends Service {
    ...
    public static final String TAG = PushClientService.class.getName();

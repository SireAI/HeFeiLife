...
static  class Wrapper {
    ...
    public Observable<?> apply(Observable<? extends Throwable> observable) throws Exception {
        return observable.zipWith(Observable.range(1, count + 1), (BiFunction<Throwable, Integer, Wrapper>) (throwable, integer) ->
                new Wrapper(throwable, integer)).flatMap(((Function<Wrapper, ObservableSource<?>>) wrapper -> {

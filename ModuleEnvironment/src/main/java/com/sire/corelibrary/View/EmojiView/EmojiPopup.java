...
import com.sire.corelibrary.View.EmojiView.listeners.OnEmojiBackspaceClickListener;
...
import com.sire.corelibrary.View.EmojiView.listeners.OnEmojiPopupDismissListener;
import com.sire.corelibrary.View.EmojiView.listeners.OnEmojiPopupShownListener;
import com.sire.corelibrary.View.EmojiView.listeners.OnSoftKeyboardCloseListener;
import com.sire.corelibrary.View.EmojiView.listeners.OnSoftKeyboardOpenListener;

import static com.sire.corelibrary.View.EmojiView.Utils.checkNotNull;
...
public final class EmojiPopup {
    ...
    EmojiPopup(@NonNull final View rootView, @NonNull EmojiEditText emojiEditText,
        ...
        final OnEmojiClickListener clickListener = new OnEmojiClickListener() {
            ...
            public void onEmojiClick(@NonNull final EmojiImageView imageView, @NonNull final Emoji emoji) {
                EmojiPopup.this.emojiEditText.input(emoji);

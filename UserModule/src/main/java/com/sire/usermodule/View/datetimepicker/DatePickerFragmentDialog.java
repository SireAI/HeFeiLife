package com.sire.usermodule.View.datetimepicker;
...
public class DatePickerFragmentDialog extends DialogFragment implements DatePickerDialog.OnDateSetListener {
    ...
    @NonNull @Override public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(getContext(), android.R.style.Theme_DeviceDefault_Light_Dialog_Alert, this, calendar.get(Calendar.YEAR),
    ...
    public static DatePickerFragmentDialog newInstance(boolean withTime) {
        return newInstance(DateTimeBuilder.get().withTime(withTime));
    }

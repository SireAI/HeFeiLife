...
public class CommentMessage implements Serializable{
   ...
   * 被回答的评论实体
   */
  private CommentMessage questionComment;

  public CommentMessage getQuestionComment() {
    return questionComment;
  }

  public void setQuestionComment(CommentMessage questionComment) {
  ...
  public boolean equals(Object o) {
    ...
    CommentMessage comment = (CommentMessage) o;
